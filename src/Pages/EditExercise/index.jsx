...
export default function EditExercise(props) {
	...
	const getExercise = () => {
		get(
			...
			.then(response => {
				document.getElementById('form_exercise').title.value =
					response.Title;
		...
		for (var i = 0; i < subheadingCount; i++) {
			await post(
				'/subheading/',
				{
					...
					Order: document.getElementsByName(
						'subheading_order_' + i
					)[0].value,
